...
export default function HomePage() {
  ...
  const [serverState, setServerState] = useState<FootprintActionState>(initialActionState);
            ...
            <div className="space-y-6">
              ...
              <Card className="w-full">
                <CardContent className="p-6">
                  {step === "Housing" && <HousingSection form={form} />}
                  {step === "Travel" && <TravelSection form={form} />}
                  {step === "Food" && <FoodSection form={form} />}
                  {step === "Products" && <ProductsSection form={form} />}
                  {step === "Services" && <ServicesSection form={form} />}
                </CardContent>
              </Card>

              <Settings householdSize={householdSize} onChange={setHouseholdSize} />
            </div>
