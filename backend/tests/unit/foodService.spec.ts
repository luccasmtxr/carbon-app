...
describe('FoodCalculator', () => {
  ...
  it('calculates oils emissions', () => {
    ...
    expect(result).toBeCloseTo(3.65, 2);
  });
  ...
  it('calculates drinks emissions', () => {
    ...
    expect(result).toBeCloseTo(5.84, 2);
  });
